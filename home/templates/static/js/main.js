...
Ottavio.scrollController = function() {
    ...
    if ($onePageMenu.length > 0) {
        $('#one-page-menu a[href^=#], a.easedScroll').each(function(){
            var
                _this = $(this),
  ...
  var
    ...
    if ($container.length > 0) {
        ...
        if ($.fn.isotope !== undefined) {
            ...
            if ($filter.length > 0){
                $filter.on('click', 'button, a', doFilter);
            }
...
$(document).ready(function() {
    ...
    $('#dropdownMenuLogin').click(function(){
        ...
        $('#ajax-login-error').css('display','none');
        //$('#invitation-form').css('display', 'none');
        $(".ajax-loading").addClass('display-none');
    });

    $('#dropmenu-ForgotBtn').click(function(){
    ...
    $('#dropmenu-SignupBtn').click(function(){
        $('#login-form').css('display','none');
        $('#signup-message').css('display','none');
        $('#forgot-message').css('display','none');
        $('#ajax-login-error').css('display','none');
        //$('#invitation-form').css('display', 'block');
        $('#signup-form').css('display','block');
        //$("#invitation-error-message").css('display','none');
    });
    ...
    $('.SignupBtn').click(function(e){
        ...
        //$("#invitation-error-message").css('display','none');
        // Responsive
        $('div.navbar-collapse.collapse').toggleClass('in');
    });
