 ...
 * @description
 * control notification wizard step 1_5
 */
/*global angular */
((function() {
    'use strict';
    angular
        .module('app')
        .controller('step1_5Controller', ['$scope', 'Upload', '$timeout', function ($scope, Upload,$timeout) {
            ...
            var asThisController=$scope.step1_5Ctrl={};
